...
export const createHomeScreenStyles = (colors: ActivePalette, isDark: boolean) =>
  StyleSheet.create({
    ...
    chartInspectorMonthTag: {
      flexDirection: 'row',
      alignItems: 'center',
      gap: 5,
    },
    chartInspectorMonthText: {
      fontSize: 12,
      fontWeight: '700',
      color: colors.text,
    },
    ...
    chartInspectorBadgeText: {
      fontSize: 10,
      fontWeight: '700',
    },
    chartInspectorMetrics: {
      flexDirection: 'row',
      alignItems: 'center',
      justifyContent: 'space-between',
      paddingTop: 6,
    ...
    chartInspectorMetricItem: {
      flexDirection: 'row',
      alignItems: 'center',
      gap: 5,
    },
    chartInspectorMetricDot: {
      width: 7,
      height: 7,
      borderRadius: 3.5,
    },
    chartInspectorMetricLabel: {
      fontSize: 10,
      color: colors.textSecondary,
    },
    chartInspectorMetricVal: {
      fontSize: 11,
      fontWeight: '700',
      color: colors.text,
    },
    ...
    chartColBtnActive: {
      backgroundColor: isDark ? 'rgba(94, 106, 210, 0.12)' : 'rgba(30, 64, 175, 0.06)',
