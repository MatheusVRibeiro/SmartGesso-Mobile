...
import { PAYMENT_METHOD_LABELS } from '../PagamentosList';
import { createPagamentoDetalheStyles } from './styles';
...
export default function DetalhePagamentoScreen() {
  ...
  const styles = useMemo(() => createPagamentoDetalheStyles(colors, isDark), [colors, isDark]);
