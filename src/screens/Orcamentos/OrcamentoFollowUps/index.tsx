...
import { FlatList, Modal, RefreshControl, Text, View } from 'react-native';
...
import { createOrcamentoFollowUpsStyles } from './styles';
...
export default function FollowUpsScreen() {
  ...
  const styles = useMemo(() => createOrcamentoFollowUpsStyles(colors, isDark), [colors, isDark]);
